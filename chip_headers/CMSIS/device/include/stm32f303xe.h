...
#define OPAMP1_CSR_FORCEVP                                                                                             \
    OPAMP1_CSR_FORCEVP_Msk /*!< Connect the internal references to the plus input of the OPAMPX */
...
#define OPAMP2_CSR_FORCEVP                                                                                             \
    OPAMP2_CSR_FORCEVP_Msk /*!< Connect the internal references to the plus input of the OPAMPX */
...
#define OPAMP3_CSR_FORCEVP                                                                                             \
    OPAMP3_CSR_FORCEVP_Msk /*!< Connect the internal references to the plus input of the OPAMPX */
...
#define OPAMP4_CSR_FORCEVP                                                                                             \
    OPAMP4_CSR_FORCEVP_Msk /*!< Connect the internal references to the plus input of the OPAMPX */
 ...
 * @brief Specific device feature definitions (not present on all devices in the STM32F3 series)
 */
#define DAC_CHANNEL2_SUPPORT /*!< DAC feature available only on specific devices: DAC channel 2 available (may not be  \
                                available on all DAC instances DACx) */
...
#define DBGMCU_APB1_FZ_DBG_I2C3_SMBUS_TIMEOUT_Msk                                                                      \
    (0x1UL << DBGMCU_APB1_FZ_DBG_I2C3_SMBUS_TIMEOUT_Pos) /*!< 0x40000000 */
...
#define SYSCFG_CFGR1_ENCODER_MODE_TIM2                                                                                 \
    SYSCFG_CFGR1_ENCODER_MODE_TIM2_Msk /*!< TIM2 IC1 and TIM2 IC2 are connected to TIM15 IC1 and TIM15 IC2             \
                                          respectively */
...
#define SYSCFG_CFGR1_ENCODER_MODE_TIM3                                                                                 \
    SYSCFG_CFGR1_ENCODER_MODE_TIM3_Msk /*!< TIM3 IC1 and TIM3 IC2 are connected to TIM15 IC1 and TIM15 IC2             \
                                          respectively */
...
#define SYSCFG_CFGR2_LOCKUP_LOCK                                                                                       \
    SYSCFG_CFGR2_LOCKUP_LOCK_Msk /*!< Enables and locks the LOCKUP (Hardfault) output of CortexM4 with Break Input of  \
                                    TIMx */
...
#define SYSCFG_CFGR2_SRAM_PARITY_LOCK                                                                                  \
    SYSCFG_CFGR2_SRAM_PARITY_LOCK_Msk /*!< Enables and locks the SRAM_PARITY error signal with Break Input of TIMx */
...
#define SYSCFG_CFGR2_PVD_LOCK                                                                                          \
    SYSCFG_CFGR2_PVD_LOCK_Msk /*!< Enables and locks the PVD connection with TIMx Break Input, as well as the PVDE and \
...
#define IS_COMP_ALL_INSTANCE(INSTANCE)                                                                                 \
    (((INSTANCE) == COMP1) || ((INSTANCE) == COMP2) || ((INSTANCE) == COMP3) || ((INSTANCE) == COMP4) ||               \
     ((INSTANCE) == COMP5) || ((INSTANCE) == COMP6) || ((INSTANCE) == COMP7))

#define IS_COMP_COMMON_INSTANCE(COMMON_INSTANCE)                                                                       \
    (((COMMON_INSTANCE) == COMP12_COMMON) || ((COMMON_INSTANCE) == COMP34_COMMON) ||                                   \
...
#define IS_DAC_CHANNEL_INSTANCE(INSTANCE, CHANNEL)                                                                     \
    ((((INSTANCE) == DAC1) && (((CHANNEL) == DAC_CHANNEL_1) || ((CHANNEL) == DAC_CHANNEL_2))))
...
#define IS_OPAMP_ALL_INSTANCE(INSTANCE)                                                                                \
    (((INSTANCE) == OPAMP1) || ((INSTANCE) == OPAMP2) || ((INSTANCE) == OPAMP3) || ((INSTANCE) == OPAMP4))
...
#define IS_TIM_INSTANCE(INSTANCE)                                                                                      \
    (((INSTANCE) == TIM1) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM3) || ((INSTANCE) == TIM4) ||                   \
     ((INSTANCE) == TIM6) || ((INSTANCE) == TIM7) || ((INSTANCE) == TIM8) || ((INSTANCE) == TIM15) ||                  \
     ((INSTANCE) == TIM16) || ((INSTANCE) == TIM17) || ((INSTANCE) == TIM20))

/******************* TIM Instances : at least 1 capture/compare channel *******/
#define IS_TIM_CC1_INSTANCE(INSTANCE)                                                                                  \
    (((INSTANCE) == TIM1) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM3) || ((INSTANCE) == TIM4) ||                   \
     ((INSTANCE) == TIM8) || ((INSTANCE) == TIM15) || ((INSTANCE) == TIM16) || ((INSTANCE) == TIM17) ||                \
     ((INSTANCE) == TIM20))

/****************** TIM Instances : at least 2 capture/compare channels *******/
#define IS_TIM_CC2_INSTANCE(INSTANCE)                                                                                  \
    (((INSTANCE) == TIM1) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM3) || ((INSTANCE) == TIM4) ||                   \
     ((INSTANCE) == TIM8) || ((INSTANCE) == TIM15) || ((INSTANCE) == TIM20))
...
#define IS_TIM_REMAP_INSTANCE(INSTANCE)                                                                                \
    (((INSTANCE) == TIM1) || ((INSTANCE) == TIM8) || ((INSTANCE) == TIM16) || ((INSTANCE) == TIM20))
